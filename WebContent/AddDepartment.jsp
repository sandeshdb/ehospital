        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add Department Information</h4>
                  <form class="form-sample" method="post" action="SaveDepartmentInfo" >
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-4 col-form-label">Enter department name</label>
                          <div class="col-sm-8">
