        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Sorry..!! No record found for this patient.</h4>
                  <form class="form-sample" method="post" action="SavePatientDiseaseInfoServlet" >
                  
                    <div class="row">                  
                       <div class="col-md-6">
                        <div class="form-group row">
                        <label class="col-sm-9 col-form-label"><a href="viewPatient.jsp">Add Disease.</a></label>
                        <label class="col-sm-9 col-form-label"><a href="Billing.jsp">Add Other Patient Billing</a></label>
                         <label class="col-sm-9 col-form-label"><a href="viewBilling.jsp">View Other Patient Billing</a></label>
                          <div class="col-sm-3">
                           </div>
                        </div>
                      </div>
