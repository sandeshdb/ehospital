...
<%
 ...
 List<Pregister> list=blm.ViewPatientRecord();
											...
											<tbody>
												...
												<tr>
											     ...
											     <c:forEach items="${list}" var="l">
													...
													<td class="font-weight-medium">${l.pname}</td>
											   		<td class="font-weight-medium">${l.pmobileNumber}</td>
											     	<td class="font-weight-medium">${l.paddress}</td> 
											     	<td><button id="myBtn"><a href="AddDiseaseServlet?pid=${l.pid}">Add Disease Details</a></button></td>
											     	 <td><button><a href="viewPatientProfileServ?pid=${l.pid}">View more</a></button></td>
												</tr>
												   </c:forEach>
											</tbody>
										</table>							
