...
<head>
 ...
 <%
                ...
                HttpSession patient=request.getSession(false);
                Pregister pr=( Pregister)patient.getAttribute("pr");
                
               BLManager blm=new BLManager();
               List<Doctor> list=blm.ViewDoctorRecord();
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add report Information</h4>
                  <form class="form-sample" method="post" action="AddDocumnetServlet" enctype="multipart/form-data" >
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                       ...
                       <div class="col-md-6">
                        <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Upload Report</label>
                          <div class="col-sm-9">
                           <input type="file" id="reportPhoto" name="reportPhoto" class="form-control" />
                     ...
                     <div class="col-md-6" >
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" id="pdid" name="pdid" value="${pd.pdid}" />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6" >
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" id="pid" name="pid" value="${pd.pregister.pid}" />
                          </div>
                        </div>
                      </div>
                    </div>
