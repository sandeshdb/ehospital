				...
				%>
					<li class="nav-item dropdown d-none d-xl-inline-block"><a
						...
						data-toggle="dropdown" aria-expanded="false"> <span
							class="profile-text">Hello, ${pr.pname}
		...
		<div class="container-fluid page-body-wrapper">
			...
			<nav class="sidebar sidebar-offcanvas" id="sidebar">
				<ul class="nav">
						...
						<div class="nav-link">
							<div class="user-wrapper">
								...
								<div class="text-wrapper">
									<p class="profile-name">Hello ${pr.pname} </p>
									<div>
					...
					<li class="nav-item"><a class="nav-link"  href="PatientProfile.jsp"> 
						<i class="menu-icon mdi mdi-content-copy "></i>
						 <span class="menu-title">Your Profile</span> 
					</a>
					</li>
					<li class="nav-item"><a href="UpdatePatienProfile.jsp" class="nav-link" >
					 <i class="menu-icon mdi mdi-content-copy"></i>
								...
								<div class="card-body">
									...
									<div class="fluid-container">
										<div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
											<div class="col-md-1">
												<img class="img-sm rounded-circle mb-4 mb-md-0"
													src="images1/faces/face1.jpg" alt="profile image">
											</div>
										...
										<div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
											<div class="col-md-1">
												<img class="img-sm rounded-circle mb-4 mb-md-0"
													src="images1/faces/face2.jpg" alt="profile image">
											</div>
											<div class="ticket-details col-md-9">
												<div class="d-flex">
										...
										<div class="row ticket-card mt-3">
											<div class="col-md-1">
												<img class="img-sm rounded-circle mb-4 mb-md-0"
													src="images1/faces/face3.jpg" alt="profile image">
											</div>
											<div class="ticket-details col-md-9">
												<div class="d-flex">
