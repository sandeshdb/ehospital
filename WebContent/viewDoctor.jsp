...
<!-- 		<!-- partial:partials/_navbar.html -->
		<nav
			...
			<div class="navbar-menu-wrapper d-flex align-items-center">
                ...
                String name=(String)ss1.getAttribute("admin");
                ...
                %>
					...
					<li class="nav-item dropdown d-none d-xl-inline-block"><a
						...
						data-toggle="dropdown" aria-expanded="false"> <span
							class="profile-text">Hello, <%=name%>!</span> <img
...
<%-- 											   	    <td><input type="hidden" value="${l.DId}" > </td> --%>
													<td class="font-weight-medium">${l.duniqid }</td>
											   		<td class="font-weight-medium">${l.dname}</td>
											     	<td class="font-weight-medium">${l.spcialist}</td> 												   
											     	 <td><button type="submit" value="Go" href=""> <a href="viewDetailDoctorProfileServ?DId=${l.DId}">View more</a></button></td>
													<td><button id="myBtn"><a href="DeleteDoctorRecordServlet?DId=${l.DId}&dname=${l.dname}">Delete</a></button></td>
													<td><a href="EditDoctorServlet?DId=${l.DId}">Want to edit?</a></td>
													</tr>
												   </c:forEach>
											</tbody>
										</table>							
