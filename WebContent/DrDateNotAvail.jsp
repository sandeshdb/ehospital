					...
					<div class="row">
						<div class="col-12 grid-margin">
							<div class="card">
								...
								<h4 class="card-title">We are extremely sorry...!! </h4>
										
										<br>
									<h4 class="card-title">Doctor not available at this date. Please select another date or doctor</h4>
								<a href="Appointment.jsp" style="text-decoration: none;}">Select Another date</a>
