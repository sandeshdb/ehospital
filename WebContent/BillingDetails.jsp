...
<body>
	<%
		...
		if(pd.isEmpty()==true){
		  ...
		  System.out.println(pd.get(1).getPdisease().getDiseaseName());
					...
					<li class="nav-item dropdown d-none d-xl-inline-block"><a
						...
						data-toggle="dropdown" aria-expanded="false"> <span
							class="profile-text">Hello,
								${pd.get(0).getPregister().getPname()}!</span> <img
						...
						<div class="nav-link">
							<div class="user-wrapper">
								...
								<div class="text-wrapper">
									<p class="profile-name">Hello ${pd.get(0).getPregister().getPname()}</p>
									<div>
...
<%-- 															    <td class="font-weight-medium"> ${h.pdispease.disneaseName} </td> --%>
																	...
																	<a href="PSeeBillingServlet?pdid=${h.getPdisease().getPdid()}">
																	View Bill</a></td>
															</tr>
															</c:forEach>
														</tbody>
