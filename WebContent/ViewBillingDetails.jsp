...
%>
  ...
  int pid=(int)session.getAttribute("b");
 List <Bill> pd=blm.searchByPatientIdInBill(pid);
								...
								<div class="card-body">
									...
									<table border="">
										<tr>
											...
											<td>${pd.get(0).getPregister().getPname()}</td>
										</tr>
										<tr>
											<th class="font-weight-medium">Address</th>
											<td>${pd.get(0).getPregister().getPaddress()}</td>
										</tr>
										<tr>
											<th class="font-weight-medium">Contact No.</th>
											<td>${pd.get(0).getPregister().getPmobileNumber()}</td>
										</tr>
										
											<th class="font-weight-medium">Email Address</th>
											<td>${pd.get(0).getPregister().getPemailid()}</td>
										</tr>
									...
									<div class="table-responsive">
										...
										<table class="table table-bordered">
											...
											<tbody>
											    ...
											    <c:forEach items="${pd}" var="h">
										  <td class="font-weight-medium">${h.getPdisease().getAdmissionDate()}</td>
										  <td class="font-weight-medium">${h.getPdisease().getDiseaseName()} </td>
										  <td class="font-weight-medium">${h.getPdisease().getDoctor().getDname()} </td>
										  <td class="font-weight-medium">${h.getPdisease().getInchargeName()}</td>
										  <td class="font-weight-medium">${h.getPdisease().getWardno()}</td>
										 <td class="font-weight-medium">${h.getPdisease().getBedno()}</td>
										  <td class="font-weight-medium"><a href="SeeBillingServlet?pdid=${h.getPdisease().getPdid()}">View Bill</a></td>
										</tr>
										   </c:forEach>
											</tbody>
										</table>							
