...
List<Department> list=blm.viewDepartmentList();
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add Doctor Information</h4>
                  <form class="form-sample" method="post" enctype="multipart/form-data" action="SaveDoctorInfo" >
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label"><span style="color: red;">*</span>Name</label>
                          <div class="col-sm-9">
                       ...
                       <div class="col-md-6">
                        <div class="form-group row">
                        <label class="col-sm-3 col-form-label"><span style="color: red;">*</span>Upload Image</label>
                          <div class="col-sm-9">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label"><span style="color: red;">*</span>Contact No.</label>
                          <div class="col-sm-9">
                            <input class="form-control" type="text" id="mob" name="mobno" placeholder="" required="required" />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label"><span style="color: red;">*</span>Department</label>
                          <div class="col-sm-9">
                                 <select name="department" class="form-control" required="required">
                                 <option value="">Select Department</option>
                               <c:forEach items="${list}" var="l">
                               <option  value="${l.deptname}">${l.deptname}</option>
                                </c:forEach>
                                </select>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Specialist</label>
                           <div class="col-sm-9">
                                <input type="text" id="specialist" name="specialist" class="form-control" placeholder="" />
                          </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="expe" name="expe" placeholder="In years" required="required"/>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label"><span style="color: red;">*</span>Joining Date</label>
                          <div class="col-sm-9">
                            <input type="date" class="form-control" id="jdate" name="jdate" placeholder=""  required="required"/>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                        <label class="col-sm-3 col-form-label"><span style="color: red;">*</span>Schedule Day</label>
                          <div class="col-sm-9">
<!-- Day Sun -->
<div class="custom-control custom-checkbox" >
  <input type="checkbox" class="custom-control-input" id="sun" name="days" value="Sunday" >
  <label class="custom-control-label" for="sun">Sunday</label>
</div>

<!-- Day mon -->
<div class="custom-control custom-checkbox">
    <input type="checkbox" class="custom-control-input" id="mon" value="Monday" name="days">
    <label class="custom-control-label" for="mon">Monday</label>
</div>

<!-- Day tues -->
<div class="custom-control custom-checkbox">
    <input type="checkbox" class="custom-control-input" id="tues" name="days" value="Tuesday">
    <label class="custom-control-label" for="tues">Tuesday</label>
</div>
<div class="custom-control custom-checkbox">
    <input type="checkbox" class="custom-control-input" id="wed" name="days" value="Wednesday">
    <label class="custom-control-label" for="wed">Wednesday</label>
</div>
<!-- Day thu -->
<div class="custom-control custom-checkbox">
  <input type="checkbox" class="custom-control-input" id="thu" name="days" value="Thursday">
  <label class="custom-control-label" for="thu">Thursday</label>
</div>

<!-- Day fri -->
<div class="custom-control custom-checkbox">
    <input type="checkbox" class="custom-control-input" id="fri" name="days" value="Friday">
    <label class="custom-control-label" for="fri">Friday</label>
</div>

<!-- Day sat -->
<div class="custom-control custom-checkbox">
    <input type="checkbox" class="custom-control-input" id="sat" name="days" value="Saturday">
    <label class="custom-control-label" for="sat">Saturday</label>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-6 col-form-label"><span style="color: red;">*</span>InTime</label>
                          <div class="col-sm-6">
                            <input type="time" class="form-control"  name="intime" required="required"/>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-6 col-form-label">OutTime</label>
                          <div class="col-sm-6">
                            <input type="time" class="form-control"  name="outtime" required="required" />
                          </div>
                        </div>
                      </div>
                    </div>
