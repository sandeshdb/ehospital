					...
					<div class="row">
							...
							<div class="card">
								<div class="card-body">
									...
									<form class="form-sample" method="post"
										enctype="multipart/form-data" action="EditDoctorServlet">
										...
										<div class="row">
											...
											<div class="col-md-7">
												<div class="form-group row">
											<img alt="Dr. img" src="GetImage.jsp?DId=${dr.DId}"
															width="150px" height="100px;">													<div class="col-sm-9">
												...
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="text" id="name" name="name"
															class="form-control" value="${dr.dname}" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="email" id="emailid" name="emailid"
															value="${dr.demailid}" class="form-control" />
													</div>
												</div>
											</div>
										</div>
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input class="form-control" type="text" id="mob"
															name="mobno" value="${dr.mobileNumber}" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="text" id="address" name="address"
															value="${dr.address}" class="form-control" />
													</div>
												</div>
											</div>
										</div>
												...
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="text" id="Qualification" name="Qualification"
															value="${dr.qulification}" class="form-control" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="text" class="form-control" id="expe"
															name="expe" value="${dr.expirence}"
												...
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="text" id="specialist" name="specialist"
															value="${dr.spcialist}" class="form-control"
															placeholder="" />
													</div>
												...
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="date" class="form-control" id="jdate"
															name="jdate" value="${dr.joiningDate}" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                            <input type="time" class="form-control"  value="${dr.inTime }" name="intime"  required="required"/>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                            <input type="time" class="form-control" value="${dr.outTime }"  name="outtime" required="required" />
                          </div>
                        </div>
                      </div>
                    </div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group row">
													<label class="col-sm-3 col-form-label">Schedule Day</label>
													<div class="col-sm-9">
														<!-- Day Sun -->
														<div class="custom-control custom-checkbox">
															<input type="checkbox" class="custom-control-input"
																id="sun" name="days" value="Sunday"> <label
																class="custom-control-label" for="sun">Sunday</label>
														</div>

														<!-- Day mon -->
														<div class="custom-control custom-checkbox">
															<input type="checkbox" class="custom-control-input"
																id="mon" value="Monday" name="days"> <label
																class="custom-control-label" for="mon">Monday</label>
														</div>

														<!-- Day tues -->
														<div class="custom-control custom-checkbox">
															<input type="checkbox" class="custom-control-input"
																id="tues" name="days" value="Tuesday"> <label
																class="custom-control-label" for="tues">Tuesday</label>
														</div>
														<div class="custom-control custom-checkbox">
															<input type="checkbox" class="custom-control-input"
																id="wed" name="days" value="Wednesday"> <label
																class="custom-control-label" for="wed">Wednesday</label>
														</div>
														<!-- Day thu -->
														<div class="custom-control custom-checkbox">
															<input type="checkbox" class="custom-control-input"
																id="thu" name="days" value="Thursday"> <label
																class="custom-control-label" for="thu">Thursday</label>
														</div>

														<!-- Day fri -->
														<div class="custom-control custom-checkbox">
															<input type="checkbox" class="custom-control-input"
																id="fri" name="days" value="Friday"> <label
																class="custom-control-label" for="fri">Friday</label>
														</div>

														<!-- Day sat -->
														<div class="custom-control custom-checkbox">
															<input type="checkbox" class="custom-control-input"
																id="sat" name="days" value="Saturday"> <label
																class="custom-control-label" for="sat">Saturday</label>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="col-md-6" style="visibility: hidden;"> 
												<div class="form-group row">
													<label class="col-sm-3 col-form-label">Dr.id
														Time</label>
													<div class="col-sm-9">
														<input type="text" class="form-control" value="${dr.duniqid}"
															name="duid" />
													</div>
												</div>
											</div>
