        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add Patient disease Information</h4>
                  <form class="form-sample" method="post" action="SavePatientDiseaseInfoServlet" >
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                       ...
                       <div class="col-md-6">
                        <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Doctor reference</label>
                          <div class="col-sm-9">
                           <select name="drefernce" class="form-control">
                    ...
                    <div class="row">
                     <div class="col-md-6"  >
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" id="wardno" name="wardno"  />
                          </div>
                        </div>
                      </div>
                     <div class="col-md-6"  >
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" id="bedno" name="bedno"  />
                          </div>
                        </div>
                      </div>
                    </div>
                     ...
                     <div class="col-md-6" >
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">In charge Name</label>
                          <div class="col-sm-9">
                    ...
                    <div class="row">
                     <div class="col-md-6"  style="visibility: hidden;">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" id="mobno" name="pid" value="${pr.pid}" />
                          </div>
                        </div>
                      </div>
                     <div class="col-md-6">
