...
<body>
	<%
		...
		p = blm.searchByPatientId(pid);
		System.out.print("Patient Id is:" + p.getPid());
				...
				<ul class="navbar-nav navbar-nav-right">
					...
					<li class="nav-item dropdown d-none d-xl-inline-block"><a
						...
						data-toggle="dropdown" aria-expanded="false"> <span
							class="profile-text">Hello, ${pr.pname}! </span> <img
												...
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="text" id="name" name="name"
															class="form-control" value="${pr.pname }" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												...
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="email" id="emailid" name="emailid"
															class="form-control" value="${pr.pemailid}" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input class="form-control" type="text" id="password"
															name="password" value="${pr.password }" />
													</div>
												</div>
											</div>
										</div>
												...
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<label class="radio-inline"><input type="radio"
															name="gender" value="Female">Female</label> <label
												...
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="date" id="dob" name="dob"
															class="form-control" value="${pr.dob }" />
													</div>
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input class="form-control" type="text" id="mobno"
															name="mobno" value="${pr.pmobileNumber}" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
