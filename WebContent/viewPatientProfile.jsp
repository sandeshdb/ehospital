...
%>
  ...
  int pid=(int)session.getAttribute("pd");
								...
								<div class="card-body">
									...
									<table border="">
										...
										<tr>
											...
											<td>${pd.get(0).getPregister().getGender()}</td>
										</tr>
										<tr>
											<th class="font-weight-medium">Date of Birth</th>
											<td>${pd.get(0).getPregister().getDob()}</td>
										</tr>
										<tr>
										...
										<tr>
											<th class="font-weight-medium">Password</th>
											<td>-</td>
										</tr>
									</table>
								</div>
								...
								<div class="card-body">
									...
									<div class="table-responsive">
										...
										<table class="table table-bordered">
										  ...
										  <td class="font-weight-medium">${h.getAdmissionDate()}</td>
										  <td class="font-weight-medium">${h.getDiseaseName()} </td>
										  <td class="font-weight-medium">${h.getDoctor().getDname()} </td>
										  <td class="font-weight-medium">${h.getInchargeName()}</td>
										  <td class="font-weight-medium">${h.getWardno()}</td>
										  <td class="font-weight-medium">${h.getBedno()}</td>			 
										  <td class="font-weight-medium"><a href="ReportImageServlet?pdid=${h.getPdid()}">View Report</a></td>
										</tr>
										   </c:forEach>
											</tbody>
										</table>							
